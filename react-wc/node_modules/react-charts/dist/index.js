...
function useHooks(fn) {
  ...
  function HookWrapper(props, ref) {
    return React.createElement(HookComponent, _extends$1({}, props, { innerRef: ref }));
  }
...
function useDeepMemo(fn, obj) {
  ...
  var changed = !equal(watchRef.current, obj);
  if (changed) {
...
function useSeriesStyle(series) {
  var _useContext = useContext(ChartContext),
      ...
      getStyles = _useContext2$.getStyles;
...
function useDatumStyle(datum) {
  var _useContext3 = useContext(ChartContext),
      ...
      getDatumStyles = _useContext4$.getDatumStyles;
...
function Path$1(_ref) {
  ...
  return React.createElement('path', _extends({}, rest, { style: resolvedStyle }));
}
...
var Line = function (_React$Component) {
  ...
  createClass(Line, [{
    ...
    value: function render() {
      ...
      return React.createElement('line', _extends({}, rest, { style: resolvedStyle }));
    }
  }]);
  return Line;
}(React.Component);
...
var Text = function (_React$Component) {
  ...
  createClass(Text, [{
    ...
    value: function render() {
      ...
      return React.createElement('text', _extends({}, rest, { style: resolvedStyle }));
    }
  }]);
  return Text;
}(React.Component);
...
var Group = React.forwardRef(function Group(props, ref) {
  return React.createElement('g', _extends({}, props, { ref: ref }));
});
...
function Tooltip() {
  ...
  var primaryAxes = chartState.primaryAxes,
      ...
      getDatumStyles = chartState.getDatumStyles,
  ...
  var renderProps = _extends({}, chartState, {
    ...
    getStyle: function getStyle(datum) {
      return datum.getStatusStyle(resolvedFocused, getDatumStyles);
    },
...
function ChartInner(_ref) {
  ...
  var focusOrderedStackData = focused ? [orderedStackData[focusedSeriesIndex]].concat(toConsumableArray(orderedStackData.slice(0, focusedSeriesIndex)), toConsumableArray(orderedStackData.slice(focusedSeriesIndex + 1))) : orderedStackData;
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(Voronoi$1, null),
        React.createElement(
          'g',
          { className: 'axes' },
          [].concat(toConsumableArray(primaryAxes), toConsumableArray(secondaryAxes)).map(function (axis) {
            return React.createElement(Axis, _extends({ key: axis.id }, axis));
          })
        ),
        React.createElement(
          'g',
    ...
    React.createElement(Cursor$1, { primary: true }),
    React.createElement(Cursor$1, null),
    React.createElement(Brush$1, null),
    React.createElement(Tooltip$1, null)
  );
}
...
function Circle$1(_ref) {
  ...
  return React.createElement('circle', _extends({}, rest, { cx: x || 0, cy: y || 0, r: 1, style: resolvedStyle }));
}
...
function Line$1(_ref) {
  ...
  var renderedPath = useDeepMemo(function () {
...
function Area(_ref) {
  ...
  var renderedAreaPath = useDeepMemo(function () {
  ...
  var renderedLinePath = useDeepMemo(function () {
...
function TooltipRenderer(props) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      groupMode === groupModeSeries ? React.createElement(
        'strong',
        null,
        datum.seriesLabel
      ) : groupMode === groupModeSecondary ? React.createElement(
        'strong',
        null,
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        secondaryAxis && secondaryAxis.stacked && datum.group.length > 1 ? React.createElement(
          'tr',
          null,
          React.createElement(
            'td',
...
function Chart(_ref, ref) {
  ...
  return React.createElement(
    ...
    React.createElement(ChartInner$1, _extends({ handleRef: handleRef }, rest))
  );
}
